...
{
	{
		_WT("test_command"), _WT("test"), _WT("test function"), 1, NULL, SDT_INT, 0, LVL_SIMPLE, 0, 0, sizeof hELibTest__CommandArgs / sizeof hELibTest__CommandArgs[0],
		hELibTest__CommandArgs
	},
	{
		_WT("hELib_Sort_QuickSort"), _WT("hELib_Sort_QuickSort"), _WT("Providing quick-sort algorithm to sort array."),
		1, NULL, SDT_BOOL, 0, LVL_HIGH, 0, 0, sizeof hELib_Sort_QuickSort__CommandArgs / sizeof hELib_Sort_QuickSort__CommandArgs[0], hELib_Sort_QuickSort__CommandArgs
	}
};
